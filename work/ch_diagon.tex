...
\textbf{Rappel.} $f : E \to E$ est appelé un \defi{endomorphisme} si $f$ est une application linéaire de $E$ dans lui-même. Autrement dit, pour tout $v\in E$, $f(v) \in E$ et en plus pour tout $u,v \in E$, et tout $\alpha \in \Kk$ :
...
Soit $f$ un endomorphisme de $E$. Soient $\lambda_1,\ldots,\lambda_r$, $r$ valeurs propres \evidence{distinctes} de $f$. Alors les sous-espaces propres associés $E_{\lambda_1},\ldots,E_{\lambda_r}$ sont en somme directe.
\end{theoreme}
...
\begin{definition}
On dit que l'endomorphisme $f : E \to E$ est \defi{diagonalisable} 
...
\begin{itemize}
  ...
  \item Une racine de multiplicité $2$ est une \defi{racine double}...    
...
\begin{definition}
Un polynôme $P(X) \in \Kk[X]$ est \defi{scindé} sur $\Kk$ si 
...
\begin{itemize}
  \item D'après le théorème de d'Alembert-Gauss :
   \mybox{Tous les polynômes sont scindés si le corps de base est $\Cc$.}
