...
Il est plus facile de manipuler des nombres que des lettres, aussi nous passons à une formulation ma\-thématique.
...
est le décalage. \codeinline{(x+k)\%26} renvoie le reste modulo $26$ de la somme \codeinline{(x+k)}.
...
%-------------------------------------------------------
\subsection{Chiffrement mono-alphabétique}
...
sur Terre ! Si un ordinateur pouvait tester $1 \; 000\; 000$ de clés par seconde, il lui faudrait alors
...
toutes les combinaisons possibles sans problème, il n'est pas question de parcourir
...
Avantages : à partir d'une clé principale on a généré une longue liste de clés secondaires.
...
Dans le vrai protocole du DES, la clé principale est de taille $64$ \emph{bits},
...
\centerline{<<La sécurité d'un système de chiffrement ne doit reposer que sur la clé.>>}
...
%-------------------------------------------------------
\subsection{Chiffrement à clé privée}

Petit retour en arrière.
Les protocoles étudiés dans les chapitres précédents étaient des \defi{chiffrements à clé privée}.
...
\item Alice et Bruno utilise cette clé dans un protocole de chiffrement à clé privée.
\end{itemize}
...
que l'on va manipuler ont des dizaines voir des centaines de chiffres.
